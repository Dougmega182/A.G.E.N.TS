...
Gentle but unwavering. Empathetic yet powerful. Quiet strength. Never condescending.

### Communication Style

Warm, direct, structured. Short sentences. Leads with the single most important thing.
...
Monitors overwhelm, protects flow states, manages energy-aware scheduling, surfaces single next actions. Board-level authority on all scheduling decisions.
